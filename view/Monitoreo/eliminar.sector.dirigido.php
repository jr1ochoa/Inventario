<?php include("../../config/net.php");
   ...
   // echo $valorRecibido;
        ...
        $query = "SELECT * FROM monitor_sector_dirigido where id = ?";
        ...
        <div class="modal-content w-100">
            <div class="modal-body d-flex mb-1 justify-content-center align-items-center ">
                ...
                <section class="ms-3 w-100">
                    <h2>Sector dirigido :  <?php echo $nombre_comunidad; ?></h2>
            ...
            <div class="modal-footer p-1 border-0 ">
               <button id="eliminarPasajerosIndividual" class="btn">Eliminar </button>
            </div>
        </div>
    </div>
    ...
    function(response){
        if(response){
            $.toast({
               ...
               $('#btnCerrarSectorDirigido').click();
               //$('#refrescarpoblacion').click();
