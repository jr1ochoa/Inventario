...
<table class="table-sm table table table-bordered colorFondo mt-2 table-hover" style="background-color: #FFFFFF; border-radius:8px;">
   ...
   // include("../../config/net.php");
    ...
    $query = "SELECT * FROM monitor_productos where id_generalidad_proyecto = ?";
    ...
    while ($data = $data3->fetch()) {
        ...
        <tr>       
            ...
            <td> <button id="'.$data[0].'" class="btn btn-sm mt-0  pt-0" style="background-color: #1A4262; color:white;"  onclick="funcioneEditarProductos('.$data[0].')" data-bs-toggle="modal" data-bs-target="#EditarProductos">
        ...
        <td> <button id="'.$data[0].'" class="btn btn-sm mt-0  pt-0" style="background-color: #1A4262; color:white;"  onclick="funcioneEliminarProductos('.$data[0].')" data-bs-toggle="modal" data-bs-target="#EliminarProductoss">
...
<div class="modal fade" id="EliminarProductoss" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header colorEncabezadoLista">
        <h5 class="modal-title" id="exampleModalLabel" style="color:white;">EDITAR RESULTADOS DE LA FICHA</h5>
      ...
      <div id="EliminarProductos22"></div>
...
<script src="view/Monitoreo/editar.productos.js"></script>
<script src="view/Monitoreo/eliminar.productos.js"></script>