<?php include("../../config/net.php");
   ...
   // echo $valorRecibido;
        ...
        $query = "SELECT * FROM monitor_area_cargo where id = ?";
        ...
        <div class="modal-content w-100">
            <div class="modal-body d-flex mb-1 justify-content-center align-items-center ">
                ...
                <section class="ms-3 w-100">
                    <h2>Aporte Área/Sub Programa :  <?php echo $nombre_comunidad; ?></h2>
            ...
            <div class="modal-footer p-1 border-0 ">
               <butto id="eliminarAreaSubProgramas2" class="btn">Eliminar </butto>
            </div>
        </div>
    </div>
...
<script>
   $('#eliminarAreaSubProgramas2').click(function(){ 
// alert("Hola Mundo");

// Deshabilitar la empresa
$.post("process/index.php", {
process: "monitoreo_proyecto", 
action: "deleteareaPresupuestaria",    
...
idObjetivoGeneralDelete: $("#idObjetivoGeneralDelete").val()
    ...
    function(response){
        if(response){
            $.toast({
                    heading: 'Finalizado',
                    text: "Área / Sub programa eliminado con éxito",
               ...
               $('#btnCerrarMODAlAreaSubPrograma').click();
               //$('#refrescarAreasyProgramas').click();
