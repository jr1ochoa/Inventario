        ...
        <div class="modal-content w-100">
            <div class="modal-body d-flex mb-1 justify-content-center align-items-center ">
                ...
                <section class="ms-3 w-100">
                    <h2>Nombre Lista Presupuestaria :  <?php echo $nombre_comunidad; ?></h2>
            ...
            <div class="modal-footer p-1 border-0 ">
               <butto id="eliminarListaPresupuestaria" class="btn">Eliminar </butto>
            </div>
        </div>
    </div>
...
<script>
   $('#eliminarListaPresupuestaria').click(function(){ 
// alert("Hola Mundo");

// Deshabilitar la empresa
$.post("process/index.php", {
process: "monitoreo_proyecto", 
action: "deletelistaPrespuestaria",    
...
idObjetivoGeneralDelete: $("#idObjetivoGeneralDelete").val()
    ...
    function(response){
        if(response){
            $.toast({
                    heading: 'Finalizado',
                    text: "Lista Presupuestaria eliminada con éxito",
               ...
               $('#btnCerrarMODALListaPresupuestaria').click();
