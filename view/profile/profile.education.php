...
<div class="col-12 col-12-xsmall mb-4">
    <h2><?= sanear_string($DataEdu[2]);?></h2>
</div>
<table id="UserTable" class="display" style="width:100%">
    <tr>
        <th>Institución</th>
        <th><?= sanear_string($DataEdu[2]); ?></th>
    </tr>
    <tr>
        <th>Nivel Educativo</th>
        <th><?= sanear_string($DataEdu[1]);?></th>
    </tr>
    <tr>
        <th>Grado</th>
        <th><?= sanear_string($DataEdu[3]);?></th>
    </tr>
    <tr>
        <th>Dirección</th>
        <th><?= sanear_string($DataEdu[4]);?></th>
    </tr>
    <tr>
        <th>Teléfono</th>
        <th><?= sanear_string($DataEdu[5]);?></th>
    </tr>
    <tr>
        <th>Sitio Web</th>
        <th><?= sanear_string($DataEdu[6]); ?></th>
    </tr>
    <tr>
        <th>Año de Inicio</th>
        <th><?= sanear_string($DataEdu[7]);?></th>
    </tr>
    <tr>
        <th>Año de Finalización</th>
        <th><?= sanear_string($DataEdu[8]);?></th>
    </tr>
    <tr>
        <th>Estado</th>
        <th><?= sanear_string($DataEdu[9]); ?></th>
    </tr>
    <tr>
        <th>Porcentaje</th>
        <th><?= sanear_string($DataEdu[10]);?></th>
    </tr>
    <tr>
        <th>Periodo</th>
        <th><?= sanear_string($DataEdu[11]);?></th>
    </tr>
<tbody>
...
<?php }else{ ?>
    ...
    <form action="process/" method="post" id="formProfile">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" name="data1" value="<?= sanear_string($DataEdu[1]); ?>">
        </div>

        <div class="mb-3">
            <label for="recipient-name" class="col-form-label">Institución:</label>
            <input type="text" class="form-control" name="data2" value="<?= sanear_string($DataEdu[2]); ?>">
        </div>

        <div class="mb-3">
            <label for="recipient-name" class="col-form-label">Nivel, Título o Diploma obtenido:</label>
            <input type="text" class="form-control" name="data3" value="<?=  sanear_string($DataEdu[3]); ?>">
        </div>

        <div class="mb-3">
            <label for="recipient-name" class="col-form-label">Dirección:</label>
            <input type="text" class="form-control" name="data4" value="<?=  sanear_string($DataEdu[4]); ?>">
        </div>

        <div class="mb-3">
            <label for="recipient-name" class="col-form-label">Teléfono:</label>
            <input type="text" class="form-control" name="data5" value="<?=  sanear_string($DataEdu[5]); ?>">
        </div>

        <div class="mb-3">
            <label for="recipient-name" class="col-form-label">Sitio Web:</label>
            <input type="text" class="form-control" name="data6" value="<?=  sanear_string($DataEdu[6]); ?>">
        </div>

        <div class="mb-3">
            <label for="recipient-name" class="col-form-label">Año de Inicio:</label>
            <input type="number" class="form-control" name="data7" value="<?=  sanear_string($DataEdu[7]); ?>">
        </div>

        <div class="mb-3">
            <label for="recipient-name" class="col-form-label">Año de Finalización:</label>
            <input type="number" class="form-control" name="data8" value="<?=  sanear_string($DataEdu[8]); ?>">
        </div>

        <div class="mb-3">
            <label for="recipient-name" class="col-form-label">Estado:</label>
            <input type="text" class="form-control" name="data9" value="<?=  sanear_string($DataEdu[9]); ?>">
        </div>
 
        <div class="mb-3">
            <label for="recipient-name" class="col-form-label">Porcentaje:</label>
            <input type="text" class="form-control" name="data10" value="<?=  sanear_string($DataEdu[10]); ?>">
        </div>

        <div class="mb-3">
            <label for="recipient-name" class="col-form-label">Periodo:</label>
            <input type="text" class="form-control" name="data11" value="<?=  sanear_string($DataEdu[11]); ?>">
        </div>
        ...
        ?>
            <p>¿Está seguro que desea eliminar la Información Institucional <b><?= sanear_string($DataEdu[2]);?> - <?=sanear_string($DataEdu[1]);?> - <?=utf8_encode($DataEdu[3]);?></b>?</p>
        <?php } ?> 
    </form>
<?php } ?>