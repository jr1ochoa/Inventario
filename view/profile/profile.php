...
$query = "SELECT DISTINCT u.id, u.username, u.type FROM users as u 
            INNER JOIN employee as e on u.id = $iu";
                ...
                <div class="col-lg-12 col-md-12 col-xs-12">
                    ...
                    <table style="width: 100%;">
                        ...
                        <tr>
                            ...
                            <td style="padding-left: 20px;"><?= $dataUser[2] ?></td>
                        ...
                        if ($Positions->rowCount() > 0) {
                            ...
                            echo "<tr><td>&Aacute;rea: </td><td>".sanear_string($datap[0])."</td></tr>

                                        <tr><td>Cargo: </td><td>".sanear_string($datap[1])."</td></tr>";
                    ...
                    //Cargar datos institucionales de empleado
                    ...
                    if ($DatosInstitucionales->rowCount() > 0) {
                        ...
                        if($_SESSION["type"] == "RRHH")

                            $correo = "<a role='button' style='color:$color; text-decoration: none;'  data-bs-toggle='modal' data-bs-target='#exampleModal'>Ingresa los datos institucionales dando clic <ins>aqui</ins></a>";
                    ...
                    <table style="width: 100%;" class="mt-5">
                        ...
                        <tr>
                            ...
                            <td colspan='2'><b>Datos Institucionales</b></td>

                        </tr>

                        <tr>

                            <td>Mi Correo Institucional: </td>

                            <td style="padding-left: 20px; color: <?= $color ?>"><?= $correo; ?></td>
                    ...
                    <div class="mt-5 text-center position-relative">
                        ...
                        <div class="row">
                            ...
                            <table style="width: 100%;" class="mt-3">
                                <tr>
                                    <td>Nombres: </td>
                                    <td style="padding-left: 20px;"><?= sanear_string($dataE[1] . " " . $dataE[2] . " " . $dataE[3]) ?></td>
                                </tr>
                                <tr>
                                    <td>Apellidos:</td>
                                    <td style="padding-left: 20px;"><?= sanear_string($dataE[4] . " " . $dataE[5])?></td>
                                </tr>
                                <tr>
                                    <td>Dirección:</td>
                                    <td style="padding-left: 20px;"><?= sanear_string($dataE[6])?></td>
                                </tr>
                                <tr>
                                    <td>Municipio:</td>
                                    <td style="padding-left: 20px;"><?= sanear_string($dataE[7])?></td>
                                </tr>

                                <tr>
                                    <td>Departamento:</td>
                                    <td style="padding-left: 20px;"><?= sanear_string($dataE[8])?></td>
                                </tr>
                                <tr>
                                    <td>Teléfono:</td>
                                    <td style="padding-left: 20px;"><?= sanear_string($dataE[9])?></td>
                                </tr>
                                <tr>
                                    <td>Celular:</td>
                                    <td style="padding-left: 20px;"><?= sanear_string($dataE[10])?></td>
                                </tr>
                                <tr>
                                    <td>Fecha de Nacimiento:</td>
                                    <td style="padding-left: 20px;"><?= sanear_string($dataE[11])?></td>
                                </tr>
                                <tr>
                                    <td>Género:</td>
                                ...
                                <tr>
                                    <td>Estado Civil:</td>
                                    <td style="padding-left: 20px;"><?= sanear_string($dataE[13])?></td>
                                </tr>
                            ...
                            <table style="width: 100%;" class="mt-3">
                                <tr>
                                    <td>Nacionalidad: </td>
                                    <td style="padding-left: 20px;"><?= sanear_string($dataE[14])?></td>
                                </tr>
                                <tr>
                                    <td>DUI:</td>
                                    <td style="padding-left: 20px;"><?= sanear_string($dataE[15])?></td>
                                </tr>
                                <tr>
                                    <td>Correo:</td>
                                    <td style="padding-left: 20px;"><?= sanear_string($dataE[16])?></td>
                                </tr>
                                <tr>
                                    <td>Profesión:</td>
                                    <td style="padding-left: 20px;"><?= sanear_string($dataE[17])?></td>
                                </tr>
                                <tr>
                                    <td>AFP:</td>
                                    <td style="padding-left: 20px;"><?= sanear_string($dataE[18])?></td>
                                </tr>
                                <tr>
                                    <td>Número de AFP:</td>
                                    <td style="padding-left: 20px;"><?= sanear_string($dataE[19])?></td>
                                </tr>
                                <tr>
                                    <td>ISSS:</td>
                                    <td style="padding-left: 20px;"><?= sanear_string($dataE[20])?></td>
                                </tr>
                                <tr>
                                    <td>NIT:</td>
                                    <td style="padding-left: 20px;"><?= sanear_string($dataE[21])?></td>
                                </tr>
                                <tr>
                                    <td>Altura:</td>
                                    <td style="padding-left: 20px;"><?= sanear_string($dataE[22])?></td>
                                </tr>
                                <tr>
                                    <td>Peso:</td>
                                    <td style="padding-left: 20px;"><?= sanear_string($dataE[23])?></td>
                                </tr>
                            </table>
                            </div>
                        </div>
                ...
                <div class="tab-pane fade" id="education" role="tabpanel" aria-labelledby="profile-tab">
                    ...
                    <table style="width: 100%">
                        ...
                        <tr style='display: <?= $displayInfo ?>'>
                            ...
                            <td>Institución<b><br /><?= sanear_string($data[2]) ?></b></td>

                            <td>¿Qué estudias?<b><br /><?= sanear_string($data[3]) ?></b></td>

                            <td>¿Qué nivel?<b><br /><?= sanear_string($data[4]) ?></b></td>
                    ...
                    <table style="width: 100%;" class="mt-4">
                        ...
                        while ($datar = $educationInfo->fetch()) {
                            ...
                            echo "<tr>
                                    ...
                                    <td>".  sanear_string($datar[2]) ."</td>

                                    <td>".  sanear_string($datar[1]) ."</td>

                                    <td>".  sanear_string($datar[3]) ."</td>
                        ...
                        while ($dataif = $infoFamiliar->fetch()) {
                            ...
                            echo "<tr>
                                    ...
                                    <td>$dataif[3]</td>
                                                ...
                                                <td>".sanear_string($dataif[1])."</td>

                                                <td>".sanear_string($dataif[2])."</td>                                                        

                                                <td>".sanear_string($dataif[4])."</td>

                                                <td>".sanear_string($dataif[6])."</td>                                    

                                                <td>".sanear_string($dataif[7])."</td>";
                    ...
                    ?>
                        ...
                        <table style="width: 100%;" class="mt-5">
                            ...
                            <tr>
                                ...
                                <td style="padding-left: 20px"><?= sanear_string($dataR[1]); ?></td>
                            ...
                            <tr>
                                ...
                                <td style="padding-left: 20px"><?= sanear_string($dataR[2]); ?></td>
                            ...
                            <tr>
                                ...
                                <td style="padding-left: 20px"><?= sanear_string($dataR[3]); ?></td>
                            ...
                            <tr>
                                ...
                                <td style="padding-left: 20px"><?= sanear_string($dataR[4]); ?></td>
                            ...
                            <tr>
                                ...
                                <td style="padding-left: 20px"><?= sanear_string($dataR[5]); ?></td>
                            ...
                            <tr>
                                ...
                                <td style="padding-left: 20px"><?= sanear_string($dataR[6]); ?></td>
                            ...
                            <tr>
                                ...
                                <td style="padding-left: 20px"><?= sanear_string($dataR[7]); ?></td>
                            ...
                            <tr>
                                ...
                                <td style="padding-left: 20px"><?= sanear_string($dataR[8]); ?></td>
                            ...
                            <tr>
                                ...
                                <td style="padding-left: 20px"><?= sanear_string($dataR[9]); ?></td>
                            ...
                            <tr>
                                ...
                                <td style="padding-left: 20px"><?= sanear_string($dataR[10]); ?></td>
    ...
    <form action="process/" method="post">
      ...
      <div class="modal-body">
        ...
        <div class="mb-3">
            ...
            <label for="textEmail" class="form-label">Correo Institucional</label>
        ...
        <div class="mb-3">
            ...
            <label for="txtContact" class="form-label">Mi Extensión de Contacto</label>

            <input type="text" class="form-control" id="txtContact" name="txtContact" aria-describedby="emailHelp">
