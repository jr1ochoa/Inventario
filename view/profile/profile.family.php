...
<form action="process/" method="post" id="formProfile">
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control" name="data1" value="<?= sanear_string($dataU[1]); ?>">
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control" name="data2" value="<?= sanear_string($dataU[2]); ?>">
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control" name="data3" value="<?= sanear_string($dataU[3]); ?>">
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control" name="data4" value="<?= sanear_string($dataU[4]); ?>">
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control" name="data5" value="<?= sanear_string($dataU[5]); ?>">
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control" name="data6" value="<?= sanear_string($dataU[6]); ?>">
    ...
    <p>¿Está seguro que desea eliminar el familiar <b><?=sanear_string($dataU[1]);?></b>?</p>
