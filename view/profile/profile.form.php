...
<?php ini_set('error_reporting', E_ALL & ~E_WARNING); 
...
<?php
    ...
    <form action="process/" method="post" id="formProfile">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" name="data1" value="<?= sanear_string($dataE[1]); ?>" maxlength="50" required> 
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" name="data2" value="<?= sanear_string($dataE[2]); ?>" maxlength="25" required>
        ...
        <div class="mb-3">
            ...
            <input type="text" id="txtThirdName" class="form-control" name="data3" value="<?= sanear_string($dataE[3]); ?>" maxlength="25" required>
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" name="data4" value="<?= sanear_string($dataE[4]); ?>" maxlength="50" required>
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" name="data5" value="<?= sanear_string($dataE[5]); ?>" maxlength="25" required>
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" name="data6" value="<?= sanear_string($dataE[6]); ?>" maxlength="100" required>
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" name="data7" value="<?= sanear_string($dataE[7]); ?>" maxlength="50" required>
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" name="data8" value="<?= sanear_string($dataE[8]); ?>" maxlength="50" required>
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" name="data9" value="<?= sanear_string($dataE[9]); ?>" maxlength="20" required>
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" name="data10" value="<?= sanear_string($dataE[10]); ?>" maxlength="9" required>
        ...
        <div class="mb-3">
            ...
            <input type="date" class="form-control" name="data11" value="<?= sanear_string($dataE[11]); ?>" required>
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" name="data13" value="<?= sanear_string($dataE[13]); ?>" maxlength="45" required>
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" name="data14" value="<?= sanear_string($dataE[14]); ?>" maxlength="30" required>
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" name="data15" value="<?= sanear_string($dataE[15]); ?>" maxlength="45" required>
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" name="data16" value="<?= sanear_string($dataE[16]); ?>" maxlength="50" required>
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" name="data17" value="<?= sanear_string($dataE[17]); ?>" maxlength="45" required>
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" name="data18" value="<?= sanear_string($dataE[18]); ?>" maxlength="45" required>
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" name="data19" value="<?= sanear_string($dataE[19]); ?>" maxlength="25" required>
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" name="data20" value="<?= sanear_string($dataE[20]); ?>" maxlength="25" required>
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" name="data21" value="<?= sanear_string($dataE[21]); ?>" maxlength="25" required>
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" name="data22" value="<?= sanear_string($dataE[22]); ?>" maxlength="25" required>
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" name="data23" value="<?= sanear_string($dataE[23]); ?>" maxlength="25" required>
