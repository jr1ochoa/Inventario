        ...
        <!--<h2>HOLA MUNDO</h2> -->
            <div class="container marketing">
                <div class="row" style="background-color: #F5F5F5; border-radius: 12px;">
                    ...
                    <img src="assets/images/money_14098136.png" style="width: 40%; " data-toggle="popover" title="ÁREAS QUE INCLUYE" data-bs-content="<ul><li>📋🖊️Monitoreo y Evaluación.</li><li>📑Seguimiento de OKR.</li><li>😎IT Y Desarrollo </li></ul>"/>
                    <p class=" "><b>Recaudación y Alianzas</b></p>
                    
                    <?php
                        include("recaudacionAlianzas.operaciones.php");
                    ?>
                </div>
            </div>
    </div>
