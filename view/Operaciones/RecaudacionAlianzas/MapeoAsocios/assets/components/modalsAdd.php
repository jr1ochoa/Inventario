<?php
    function addTipoEmpresa(){ // TE = Tipo Empresa
        ...
        $modalHeaderCont = <<<HTML
            <img src="view/Operaciones/RecaudacionAlianzas/MapeoAsocios/assets/Icons/add.png" width="50px" height="50px">
            <section class="ms-3 w-100 align-middle">
                <h5 class="fs-5 fw-bold mb-1">Agregar un tipo de empresa</h5>
    ...
    function addEmpresa(){ // Empr = Empresa
        ...
        $modalHeaderCont = <<<HTML
            <img src="view/Operaciones/RecaudacionAlianzas/MapeoAsocios/assets/Icons/add.png" width="50px" height="50px">
            <section class="ms-3 w-100 align-middle">
                <h5  class="fs-5 fw-bold mb-1">Agregar una empresa</h5>
    ...
    function addConvenio(){ // Conv = Convenio
        ...
        $modalHeaderCont = <<<HTML
            <img src="view/Operaciones/RecaudacionAlianzas/MapeoAsocios/assets/Icons/add.png" width="50px" height="50px">
            <section class="ms-3 w-100 align-middle">
                <h5 class="fs-5 fw-bold mb-1">Agregar un convenio</h5>
                ...
                <section class="w-100 px-1">
                    <div class="input-cont my-1 mx-2 p-1">
                        ...
                        <div class="form-check mt-2 d-flex mx-4">
                            <input class="form-check-input opacity- mt-1" type="checkbox" name="respaldoConv" id="respaldoConv" >
                            <label class="form-check-label fs-6 fw-medium ms-2" for="respaldoConv"> Este convenio esta respaldado con documentación</label>
                        </div>
                    </div>
                </section>
            </form>
        ...
        <script>
            ...
            $.extend({
                resetAddConvForm: function(){ // Función para reiniciar el formulario (Con un retraso de 500ms)
                    setTimeout(function(){
                        $('#empresaConv').prop('disabled', true) 
                        $('#empresaConv').empty() 
                ...
                validateConvForm: function(){ // Función para validar el formulario
                    $('#addConvForm').validate({
                        ...
                        rules:{
                            ...
                            numContactoConv: {  required: true, digits: true, range: [ 10000000, 99999999 ] },
