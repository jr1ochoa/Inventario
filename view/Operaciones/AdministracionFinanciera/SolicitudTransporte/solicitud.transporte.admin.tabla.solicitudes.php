...
//echo $_REQUEST['fechaActual'];
 ...
 inner join employee as s3 on s1.id_empleado = s3.id where (s1.estado = 1 or s1.estado = 3) and s1.fh_salida = ? order by s1.id desc
 ";

 $data3 = $net_rrhh->prepare($query);

 $data3->execute([$_REQUEST['fechaActual']]);
