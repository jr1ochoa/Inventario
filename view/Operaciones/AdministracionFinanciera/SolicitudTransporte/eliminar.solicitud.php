<?php include("../../../../config/net.php");
   ...
   // echo $valorRecibido;
        ...
        $query = "SELECT * FROM admin_finanzas_formulario where id = ?";
        ...
        <div class="modal-content w-100">
            <div class="modal-body d-flex mb-1 justify-content-center align-items-center ">
                ...
                <section class="ms-3 w-100">
                    <h2>Destino :  <?php echo $nombre_comunidad; ?></h2>
            ...
            <div class="modal-footer p-1 border-0 ">
               <butto id="eliminarSolicitudPermanente" class="btn">Eliminar </butto>
            </div>
        </div>
    </div>
...
<script>
   $('#eliminarSolicitudPermanente').click(function(){ 
// alert("Hola Mundo");

// Deshabilitar la empresa
$.post("process/index.php", {
    process: "administracion_finanza",
    action: "DeleteSolicitudTransporte",
