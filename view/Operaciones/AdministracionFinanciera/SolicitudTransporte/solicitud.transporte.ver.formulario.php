...
<div class="form-group mt-2">
    ...
    <textarea  class="form-control" disabled id="exampleFormControlTextarea1" rows="3"><?php echo $direccionDestino; ?></textarea>
  </div>

  <div class="form-group">
    <label for="exampleFormControlTextarea1">Motivo de la Salida:  </label>
    <textarea  class="form-control" disabled id="exampleFormControlTextarea1" rows="3"><?php echo $motivoSalida; ?></textarea>
  </div>
  ...
  <div class="row">
    ...
    <div class="col-6" id="detalleProyectoNombre" style="display:none;">
        ...
        <textarea disabled   class="form-control" id="exampleFormControlTextarea1" rows="3"><?php echo $nombreProyecto; ?></textarea>
        </div>
    </div>
  </div>
  ...
  <div class="row">
    ...
    <div class="col-6"  id="idBloqueHerramienta" style="display:none;"> 
        ...
        <textarea disabled  class="form-control" id="exampleFormControlTextarea1" rows="3"><?php echo $descripcionEquipo;?></textarea>
        </div>
    </div>
  </div>
  ...
  <div class="form-group mb-3">
        ...
        <textarea disabled  class="form-control" id="exampleFormControlTextarea1" rows="3"><?php echo $notaAdicional; ?></textarea>
        </div>
