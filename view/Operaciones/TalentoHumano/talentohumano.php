        ...
        <!--<h2>HOLA MUNDO</h2> -->
            <div class="container marketing">
                <div class="row" style="border-radius: 12px;">
                    ...
                    <img class="mt-3" src="assets/images/people_14040313.png" style="width: 40%; " data-toggle="popover" title="TALENTO HUMANO" data-bs-content="<ul><li>📋🖊️Monitoreo y Evaluación.</li><li>📑Seguimiento de OKR.</li><li>😎IT Y Desarrollo </li></ul>"/>
                    <p class=" "><b>TALENTO HUMANO</b></p>
...
<!--OPCIONES OPERATIVAS FIN-->
  ...
  <!--PUBLICAR CONTENIDO INICIO--> 
    <div class="col-md-9">
        <h3 class="mx-5 mt-3 text-aling subrayado">*<b>PANEL ADMINISTRATIVO TALENTO HUMANO  </b></h3>
    <?php
                        include("talentohumano.operaciones.php");
                    ?>
