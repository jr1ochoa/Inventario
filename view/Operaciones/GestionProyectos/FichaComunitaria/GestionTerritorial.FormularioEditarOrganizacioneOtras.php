<?php 
    ...
    echo $valorRecibido;
     ...
     include("../../../../config/net.php");
        ...
        $query = "SELECT * FROM proyecto_mapeo_comunidades_otros where id = ?";
    ...
    <div class="row">
        ...
        <div class="col">
            <div class="mb-3">
                ...
                <input  class="form-control form-control-sm" id="descripcionOtros" value="<?php echo $tipos; ?>"  type="text" placeholder=".form-control-sm" aria-label=".form-control-sm example">
            </div>
        </div>
        ...
        <div class="col">
            <div class="mb-3">
                ...
                <input  class="form-control form-control-sm" id="nombreOtros" value="<?php echo $nombreEmpresa; ?>"  type="text" placeholder=".form-control-sm" aria-label=".form-control-sm example">
            </div>
        </div>
