...
<h3><b>NECESIDADES COMUNITARIAS</b>  </h3>
...
<thead>
    ...
    {
        $query = "SELECT * FROM proyecto_mapeo_comunidades_necesidades  where id_ficha_comunitaria = ? and estado = 1   ";
        ...
        while ($data = $data3->fetch()) {
                ...
                <tr>       
                    ...
                    <td><button type='button' class='btn btn-danger' data-bs-toggle='modal' onclick='funcioneLIMINARNecesidades(".$data[0].")'  data-bs-target='#exampleModaleLIMINARComunidades'>
...
<!-- :::::::::::::::: ELIMINAR Modal ::::::::::: -->
<div class="modal fade" id="exampleModaleLIMINARComunidades" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header colorEncabezadoLista">
        <h5 class="modal-title" id="exampleModalLabel" style="color:white;">Eliminar Necesidad Comunitaria</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
       
      <div id="EliminarNecesidadComun"></div>
...
<script>
    const funcionEnviarOganizacionGubernamental = (valor) => {
            ...
            /*
            */
            $("#EDITARGubernamentales").load("view/Operaciones/GestionProyectos/FichaComunitaria/GestionTerritorial.FormularioEditarNecesidadesComunitarias.php",{
            idModal: valor
        });
           // console.log(valor);
            // Activar el modal
...
<script>
    const funcioneLIMINARNecesidades = (valor) => {
            //    data-bs-target='#exampleModal2'
            /*
            */
            $("#EliminarNecesidadComun").load("view/Operaciones/GestionProyectos/FichaComunitaria/GestionTerritorial.FormularioEliminarNecesidadesComunitarias.php",{
            idModal: valor
        });
           // console.log(valor);
            // Activar el modal
    ...
    $("#btnEditarOrganizacionesGubernamentales").click(function() {
          // document.getElementById("botonCargando").style.display="";
            $.post("process/index.php", {
                process: "proyectos",
                action: "updateNecesidadComunitaria",
                
                
                descripcionNecesidades: $("#descripcionNecesidades").val(), 
...
<script>
    ...
    $("#btnEliminarOrganizacionesGubernamentales").click(function() {
          // document.getElementById("botonCargando").style.display="";
            $.post("process/index.php", {
                process: "proyectos",
                action: "deleteNecesidadComunitaria",
