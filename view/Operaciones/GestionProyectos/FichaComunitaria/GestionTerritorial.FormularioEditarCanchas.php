<?php include("../../../../config/net.php");
  ...
  ?>
    ...
    <div class="row">
        ...
        <div class="col">
            <div class="mb-3">
                <label for="formFile" class="form-label">Tipo #2 (ACTUAL)*</label>
    ...
    <div class="row">
        ...
        <div class="mb-3">
                        ...
                        <textarea rows="2" type="text" maxlength="150" class="form-control form-control-sm" id="comentariosCanchas" placeholder="escribir..."><?php echo $comentarios; ?></textarea>
                        </div>
        </div>
    </div>
