<?php 
    function editTipoEmpresa(){ // TE = Tipo Empresa
        ...
        $modalHeaderCont = <<<HTML
            <img src="../assets/Icons/edit.png" width="50px" height="50px">
            <section class="ms-3 w-100 align-middle">
                <h5>Editar el tipo de empresa</h5>
    ...
    function editEmpresa(){ // Empr = Empresa
        ...
        $modalHeaderCont = <<<HTML
            <img src="../assets/Icons/edit.png" width="50px" height="50px">
            <section class="ms-3 w-100 align-middle">
                <h5>Editar información de empresa</h5>
    ...
    function editConvenio(){ // Conv = Convenio
        ...
        $modalHeaderCont = <<<HTML
            <img src="../assets/Icons/edit.png" width="50px" height="50px">
            <section class="ms-3 w-100 align-middle">
                <h5>Editar información del convenio</h5>
                ...
                <section class="w-100 px-1">
                    <div class="input-cont my-2 mx-2 p-1">
                        ...
                        <div class="form-check mt-2">
                            <label class="form-check-label fs-6 fw-medium " for="editRespaldoConv"> Este convenio esta respaldado con documentación</label>
                            <input class="form-check-input input-form" type="checkbox" id="editRespaldoConv" name="editRespaldoConv" />
                        </div>
                    </div>
                </section>
            </form>
