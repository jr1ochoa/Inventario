    ...
    <div id="tabAd">
        ...
        <div class="tab-content" id="myTabContent">
            ...
            <div class="tab-pane fade" id="history-tab-pane" role="tabpanel" aria-labelledby="history-tab" tabindex="0">
                ...
                <h3 class="my-4 text-center text-uppercase"><b>Historial</b></h3>
            ...
            <div class="tab-pane fade show active" id="assignment-tab-pane" role="tabpanel" aria-labelledby="assignment-tab" tabindex="0">
                ...
                <p class="fs-5 p-4 text-center">
                    ...
                    El equipo actualmente se encuentra asignado a <span class="text-primary"><?=$dataR[1]?></span>, si desea realizar una nueva asignación, haga click acá
