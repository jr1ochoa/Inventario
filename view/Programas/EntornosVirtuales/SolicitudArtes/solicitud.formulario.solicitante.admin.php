...
$idFormulario =  $_REQUEST['idSolicitudArtes'];
//echo $idFormulario;
?>
 <?php
...
<div style="height: 4px; width:100%; margin-top:-20px;background: linear-gradient(to right, #1A4262 33%, #668196 33%, #668196 66%, #CCD5DC 66%);"></div>
                                    ...
                                    <span><?php 
                                    $width = number_format($data[16], 2); // Limita a 2 decimales
...
<div class="form-group mt-5">
    <label for="exampleFormControlTextarea1">Fecha estimada de Entrega: <?php echo $fh_entrega; ?></label>
    <input id="fhEntrega"  class="form-control form-control-sm" type="date" name="times" value="<?php echo $fh_entrega; ?>">
  </div>

  <div class="form-group mt-2">
    <label for="exampleFormControlTextarea1">Personal Encargado  : </label>
...
?>
  ...
  <div class="form-group ">
    <label for="exampleFormControlTextarea1">Personal Encargado #2 (Opcional): </label>
  ...
  <div class="form-group ">
    <label for="exampleFormControlTextarea1">Prioridad: </label>
  ...
  <div class="form-group">
    <label for="exampleFormControlTextarea1">Carpeta de Entrega:  </label>
    <textarea  class="form-control" id="carpetaEntrega" rows="3"><?php echo $carpeta_entrega; ?></textarea>
  </div>
...
$("#btnRegistrarGestion").click(function(){
    ...
    function(response){
           ...
           $.toast({
            heading: 'Finalizado',
            text:response,//'Registros Guardados',
